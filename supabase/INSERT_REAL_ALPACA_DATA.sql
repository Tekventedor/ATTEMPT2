...
-- ============================================
-- YOUR REAL ORDER HISTORY (course1)
-- ============================================

-- Order 1: LMND Buy (Most Recent)
-- Filled: 2025-10-10 at 14:46:08 UTC
-- 100 shares @ $50.88
INSERT INTO public.course1 (title, description, action, symbol, quantity, price, total_value, reason, confidence_score, market_data, tags, timestamp) VALUES
...
-- VERIFY YOUR DATA
-- ============================================
SELECT 'Trading Logs (course1)' as table_name, COUNT(*) as rows FROM public.course1
UNION ALL
SELECT 'Portfolio Positions (course2)', COUNT(*) FROM public.course2;

SELECT 'Total Portfolio Value' as metric, SUM(total_value) as value FROM public.course2;
SELECT 'Total Unrealized P&L' as metric, SUM(unrealized_pnl) as value FROM public.course2;
